  ...
  <div class="resume-section" :class="{ editable: showEdit }">
    ...
    >
      ...
      <div class="exp-header">
        <span class="exp-title" :class="getFieldClass('company', idx)">
          {{ item.company }}
        </span>
      ...
      <div class="exp-meta">
        <span v-if="item.position" class="exp-position" :class="getFieldClass('position', idx)">
          {{ item.position }}
        </span>
        <span v-if="item.location" class="exp-location" :class="getFieldClass('location', idx)">
        ...
        <span v-if="item.industry" class="exp-industry">
          {{ item.industry }}
        </span>
      </div>
      ...
      <!-- 代表产品 -->
      <div v-if="item.products?.length" class="exp-products" :class="getFieldClass('products', idx)">
