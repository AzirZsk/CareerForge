package com.careerforge.interview.voice.interceptor;
...
public class VoiceHandshakeInterceptor implements HandshakeInterceptor {
    ...
    private static final String WS_PATH_PREFIX = "/careerforge/ws/interview/voice/";
    ...
    public boolean beforeHandshake(ServerHttpRequest request, ServerHttpResponse response,
        ...
        // 从路径提取 sessionId: /careerforge/ws/interview/voice/{sessionId}
    ...
    /**
     * 从路径中提取 sessionId
     * 路径格式: /careerforge/ws/interview/voice/{sessionId}
     */
