...
CREATE TABLE IF NOT EXISTS t_user (
    id BIGINT PRIMARY KEY,                  -- 主键ID（雪花ID）
...
CREATE TABLE IF NOT EXISTS t_resume (
    ...
    source_resume_id BIGINT,                -- 派生来源简历ID（为空表示主简历）
    -- 版本控制
...
CREATE TABLE IF NOT EXISTS t_resume_version (
    id BIGINT PRIMARY KEY,                  -- 主键ID（雪花ID）
    resume_id BIGINT NOT NULL,              -- 关联的主简历ID
...
CREATE TABLE IF NOT EXISTS t_resume_section (
    id BIGINT PRIMARY KEY,                  -- 主键ID（雪花ID）
    resume_id BIGINT NOT NULL,              -- 所属简历ID
    resume_version_id BIGINT,               -- 关联版本ID（为空表示当前版本）
